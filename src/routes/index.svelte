<div class="bg-white dark:bg-gray-800 ">
	<div class="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
		<h2 class="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
			<span class="block"> With solar energy you save $1392 😃 </span>
			<div class="flex items-center justify-center">
				<img src="/chart.png" />
			</div>
			<div class="flex flex-col justify-around items-center">
				<div class="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800 m-6">
					<div class="flex items-center flex-col">
						...
						<p class="text-md text-black dark:text-white ml-2">Bill</p>
					</div>
					<div class="flex flex-col justify-start">
						...
						<div class="flex items-center text-green-500 text-sm">
							...
							<span> - 5.5% </span>
							<span class="text-gray-400"> vs normal energy </span>
						</div>
					</div>
				</div>
				<span class="block text-indigo-500"> Take the test for newer estimations </span>
			</div>
		</h2>
